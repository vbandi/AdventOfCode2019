...
namespace Day9
{
    ...
    public class Day7Tests
    {
        ...
        public void Part2()
        {
            ...
            Console.WriteLine(Amplifiers.ExecuteWithFeedback(program));
        }
        ...
        [TestMethod]
        public async Task ComputerLinkingTest()
        {
            var comp1 = new IntCodeComputer();
            var comp2 = new IntCodeComputer();
            comp1.output.LinkTo(comp2.input);

            comp1.output.Post(42);
            comp2.input.Receive().ShouldBe(42);
        }
