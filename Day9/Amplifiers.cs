...
namespace Day9
{
    public static class Amplifiers
    {
        ...
        /// </summary>
        public static async Task<long> ExecuteAsync(string program)
        {
        ...
        public static long ExecuteWithFeedback(string program)
        {
        ...
        private static async Task<long> ExecutePermutationWithBuffersAsync(string program, int[] phaseSettings)
        {
        ...
        private static long ExecutePermutationWithFeedback(string program, int[] phaseSettings)
        {
            var computers = CreateAndLinkComputers();
